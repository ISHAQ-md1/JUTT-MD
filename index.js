/**
 * 𝗠𝖤𝑁𝑻𝐀𝐋-𝐉𝐔𝐓𝐓-𝐗-𝗠𝗨𝘋𝐒𝐈𝐑-𝒁𝑰𝑫𝑰-ᴹᴰ v4.5.6 - Ultimate WhatsApp Multi-Device Cloud Bot
 */
...
┃
┃ 🤖 *Bot:* ${config.BOT_NAME || '𝗠𝖤𝑁𝑻𝐀𝐋-𝐉𝐔𝐓𝐓-𝐗-𝗠𝗨𝘋𝐒𝐈𝐑-𝒁𝑰𝑫𝑰-ᴹᴰ'}
┃ 📡 *Prefix:* [ ${PREFIX} ]
┃ 🌍 *Mode:* ${config.MODE === 'private' ? 'Private 🔐' : 'Public 🌍'}
┃ 👑 *Owner:* ${config.OWNER_NAME || '𝗠𝖤𝑁𝑻𝐀𝐋-𝐉𝐔𝐓𝐓-𝐗-𝗠𝗨𝘋𝐒𝐈𝐑-𝒁𝑰𝑫𝑰-ᴹᴰ(Mental jutt x MUDASIR ziddi)'}
┃
╰━━━━━━━━━━━━━━━━━━┈⊷
...
> ⚡ _Powered by 𝗠𝖤𝑁𝑻𝐀𝐋-𝐉𝐔𝐓𝐓-𝐗-𝗠𝗨𝘋𝐒𝐈𝐑-𝒁𝑰𝑫𝑰`;
                try {
...
async function start() {
    ...
    app.listen(PORT, () => {
        ...
        console.log(chalk.white.bold(`\n⚡ 𝗠𝖤𝑁𝑻𝐀𝐋-𝐉𝐔𝐓𝐓-𝐗-𝗠𝗨𝘋𝐒𝐈𝐑-𝒁𝑰𝑫𝑰-ᴹᴰ ACTIVE! ⚡\n`));
    });
}
